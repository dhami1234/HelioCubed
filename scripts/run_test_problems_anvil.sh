...
DOMAIN_SIZE="${HELIOCUBED_TEST_DOMAIN_SIZE:-100}"
THICKNESS="${HELIOCUBED_TEST_THICKNESS:-200}"
BOX_SIZE_NONRAD="${HELIOCUBED_TEST_BOX_SIZE_NONRAD:-25}"
BOX_SIZE_RAD="${HELIOCUBED_TEST_BOX_SIZE_RAD:-25}"
